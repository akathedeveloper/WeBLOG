        ...
        <div className="text-center mb-12">
          <div className="mb-6">
            <div className="flex items-center justify-center space-x-2 mb-4">
              ...
              <span className="text-blue-600 font-semibold uppercase tracking-wider text-sm">Explore Stories</span>
            </div>
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Explore a world of knowledge, insights, and inspiration from our community of writers
            </p>
          </div>
...
if (!document.querySelector('#posts-animations')) {
  const style = document.createElement('style')
  style.id = 'posts-animations'
  style.textContent = `
    @keyframes fadeInUp {
      from {
        opacity: 0;
